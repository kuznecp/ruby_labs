...
(function () {
  ...
  $(window).one('load', function () {
    ...
    $Form.on('submit', function () {
      ...
      $.getJSON("/sequence/input.json", $Form.serialize(), function (data) {
        if (data['solution'].length === 0) {
          $Table.hide();
          $Error.show();
        } else {
          $.each(data['solution'], function ($NULL, $Value) {
            $HTML += '<tr>\
                        <td>' + $Value[0] + '</td>\
                        <td>' + $Value[1] + '</td>\
                        <td>' + $Value[2] + '</td>\
...
/******/ });
//# sourceMappingURL=application-0e74ba8202cd0d284a3b.js.map